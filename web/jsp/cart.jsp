...
<div class="container">
    <form action="${pageContext.request.contextPath}/orderServlet?method=submitOrder" method="post">
        <div class="row">
                    ...
                    <c:forEach items="${cart.cartItems}" var="cartItem">
                        <tr class="active">
                            ...
                            <td width="60" width="40%">
                                ...
                                <img src="${pageContext.request.contextPath}/${cartItem.product.pimage}" width="70"
                                     height="60">
                            </td>
                            <td width="30%">
                            ...
                            <td>
                                <a href="${pageContext.request.contextPath}/productServlet?method=removeCartItem&pid=${cartItem.product.pid}"
                                   class="delete">删除</a>
                            </td>
        ...
        <div style="margin-right:130px;">
            ...
            <div style="text-align:right;margin-top:10px;margin-bottom:10px;">
                <a href="${pageContext.request.contextPath}/productServlet?method=clearCart" id="clear" class="clear">清空购物车</a>
                <%--提交表单 --%>
